...
Controller inspected B2 phone canvas viewport captures: selected Georgia Tech sprite text extends beyond the narrow stage edge, while the separate complete detail heading wraps correctly. Assess this during B3 existing full-label/camera work; do not confuse full detail accessibility with every sprite fitting at arbitrary orbit/zoom. Evidence b2-after-320x720-canvas.png and b2-after-390x844-canvas.png. B2 fixes page layout; preserve that normal flow.
